<x-app-layout>
    ...
    <!-- <section class="row">
    <div class="col-md-12">
    <a href="{{ route('admin.supplier.index') }}" class="row">
        <x-card-sum 
            text="Jenis Barang " 
            value="{{ $supplier }}" 
            icon="users" 
    ...
    <section class="row">
        <div class="col-md-12">
            <a href="{{ route('admin.supplier.index') }}" class="text-decoration-none">
                <x-card-sum 
                    text="Jenis Barang" 
                    value="{{ $supplier }}" 
                    icon="users" 
        ...
        <div class="col-md-12">
            <a href="{{ route('admin.gudang.index') }}" class="text-decoration-none">
                <x-card-sum 
                    text="Penerima" 
                    value="{{ $jumlah_gudang }}" 
                    icon="th" 
        ...
        <div class="col-md-12">
            <a href="{{ route('admin.barang-masuk.index') }}" class="text-decoration-none">
                <x-card-sum 
                    text="Keluar Masuk Barang" 
                    value="{{ $in_out }}" 
                    icon="chart-line" 
